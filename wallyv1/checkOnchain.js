...
var client = (0, viem_1.createPublicClient)({
    ...
    transport: (0, viem_1.http)('https://mainnet.optimism.io'),
});
function checkKeyData(fid, custodyAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var contractAddress, abi, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    contractAddress = '0x00000000fc1237824fb747abde0ff18990e59b7e';
                    abi = [
                        {
                            name: 'keyDataOf',
                            type: 'function',
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching onchain data:', error_1);
                    return [3 /*break*/, 4];
